...
export default function DetailPage() {
  ...
  const countryData = useSelector(state => state.covid.statistic);
  ...
  return (<div className="max-w-7xl px-2 lg:px-4 xl:px-6 mx-auto">
    {isLoading ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-32 h-96 animate-spin flex justify-center items-center mx-auto">
